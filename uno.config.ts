...
export default defineConfig({
  shortcuts: [
    ...
    ['btn-label-danger', `${labelBtn} border-red-300 bg-red-50 text-red-800 hover:bg-red-100 dark:border-red-500 dark:bg-red-900/40 dark:text-red-200 dark:hover:bg-red-900/60`],
